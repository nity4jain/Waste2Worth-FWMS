...
<body>
<header>
        <div class="logo">Waste2<b style="color: #521DAB;">Worth</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
...
<!--             
            ...
            <br> -->
              ...
              <!-- <p style="color:  #521DAB;">username</p> -->
              <br>
              ...
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: #6847a1; color: white;padding: ;padding-left: 10px;padding-right: 10px;">Logout</a>
              </div>
              <br>
              <br>
